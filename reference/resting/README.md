...
births. Their APIs and policies are documented below. Rest, predation, randomness,
and biological calibration remain outside this reference. The first two modes
use authored feeding contacts; mobile mode derives them from actual positions.
...
From the extracted checkpoint directory:
