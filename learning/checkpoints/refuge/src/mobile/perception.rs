...
pub(crate) fn observe(
    ...
    mut grazers: Query<(&Position, &Body, &mut MobileActor), With<Grazer>>,
) {
...
pub(crate) fn choose(
    clock: Res<Clock>,
    mut grazers: Query<(Entity, &Identity, &Position, &Body, &mut MobileActor), With<Grazer>>,
